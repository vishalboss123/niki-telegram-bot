...
async def track_chat(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    profile_data = user_profile.find_one({"chat_id": chat_id, "user_id": user.id})

    added_time = 0

    if profile_data:
        last_seen = profile_data.get("last_seen", now)
        diff = now - last_seen
...
async def userinfo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    total_sec = profile_data.get("active_time", 0)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎵 Song: {profile_data.get("song", "Not set")}

📅 Join: {profile_data.get("join_date", "Unknown")}
